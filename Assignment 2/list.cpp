...
#include <strings.h>
#include <iomanip>
#include "item.hpp" // brings in the items specifications
#include "list.hpp" // brings in the list specifications
...
List::List() 
{
	...
	shopList = new Item [memSize]; // shopList now points to the first item address in the array of 'memSize'. Initalized to 4 slots
}
...
** Description: Adds the extened price for each item and rentuns the total when called.
** Parameters: None
*********************************************************************/
