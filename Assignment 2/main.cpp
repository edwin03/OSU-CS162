...
#include <iostream>
#include <string>
#include "list.hpp" //brings in the list class specification file 
#include "item.hpp" //brings in the item class specificaiton file

int main()
{
	int choice; // variable used for menu selection
	List itemList; // this creates a List variable

	std::cout << std::endl << "Welcome to Assignment 2:\nGrocery Shopping List!" << std::endl;

	do // will imidiately run the menu
	{
