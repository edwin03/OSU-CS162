/********************************************************
** Program: PressRoom.cpp
** Author: Edwin Rubio
** Description: Implementation for PressRoom.cpp file.
********************************************************/
#include "Room.hpp" // Brings in the Room.hpp specification file
#include "PressRoom.hpp" // Brings in the PressRoom.hpp spcification file
 ...
 **********************************************************/
GameStatus PressRoom::enterRoom(Player *player)
{
    int choice;
	char answer;
	Item itemName;
